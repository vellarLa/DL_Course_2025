...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        N = out_conv.shape[0]
        out_flat = out_conv.reshape(N, -1)
        out_fc1, cache_fc1 = affine_relu_forward(out_flat, W2, b2)
        scores, cache_scores = affine_forward(out_fc1, W3, b3)
        ...
        dx2 = dx2.reshape(*out_conv.shape)
        ...
        # Regularization term
        reg_term = 0.5 * self.reg * sum(np.sum(W ** 2) for W in [W1, W2, W3])
        loss += reg_term
