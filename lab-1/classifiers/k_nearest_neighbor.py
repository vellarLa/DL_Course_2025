...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                # L2 расстояние: sqrt(sum((x - y)^2))
                # В качестве x - X, в качетсве y - X_train
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(X_square + train_square - 2 * cross)
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # находим индексы k ближайших путем сортировки dist[i] по возрастанию
            ...
            # выбираем наиболее частую метку, при равенстве — меньшую
